...
Reseteo(holo,np.int32(N),np.int32(M), block=block_dim, grid=grid_dim)
...
titulo="Resultado_final"
ejex_1="Numero de pixel en x"
ejey_1="Numero de pixel en y"
nombre='Imagenes/reconstruccion_paralelizada.jpg'
tiempo_final = time.time()
tiempo= tiempo_final-tiempo_inicial
print(tiempo)
#guardado(nombre, 255*finale)

#mostrar((255*finale),titulo,ejex_1,ejey_1)
